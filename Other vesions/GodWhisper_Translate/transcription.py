...
class Transcriber:
    """
    Consumes raw audio blocks from a queue, buffers 1.2 s chunks,
    ...
    def _worker(self) -> None:
        ...
        while self._running:
            try:
                ...
                while self._running and self._buffer_samples >= SAMPLES_PER_CHUNK and len(in_flight) < MAX_IN_FLIGHT:
                    with self._lock:
